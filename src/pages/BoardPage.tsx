...
export function BoardPage() {
  ...
  async function handleToggleVisibility(newVisibility: "private" | "public") {
        if (!board || updatingVisibility || !isOwner) return;
                  ...
                  <div className="flex items-center justify-between border-b border-neutral-100 p-5 dark:border-neutral-800">
                    <div>
                      ...
                      <h2 className="text-lg font-bold text-neutral-900 dark:text-neutral-50">
                        {isOwner ? `Publish “${board.title}”` : `Collaborators on “${board.title}”`}
                      </h2>
                      {!isOwner && (
                    ...
                    <>
                      ...
                      <div className="mb-3 flex gap-2">
                        <button
                          ...
                          className={`flex-1 rounded-xl border px-3 py-2.5 text-left text-sm transition ${inviteRole === "editor"
                        ...
                        <button
                          ...
                          className={`flex-1 rounded-xl border px-3 py-2.5 text-left text-sm transition ${inviteRole === "viewer"
                              ? "border-brand bg-brand/5 text-neutral-900 dark:border-brand dark:bg-brand/10 dark:text-neutral-50"
                              : "border-neutral-200 text-neutral-600 hover:border-neutral-300 dark:border-neutral-700 dark:text-neutral-300"
                            }`}
                        >
                      ...
                      <form onSubmit={handlePublishSubmit} className="p-5 space-y-4">
                        ...
                        <div className="mb-4 flex items-center justify-between rounded-xl border border-dashed border-neutral-300 bg-neutral-50 px-3.5 py-2.5 dark:border-neutral-700 dark:bg-neutral-900/60">
                          ...
                          <button
                            ...
                            className={`inline-flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-medium transition ${linkCopied
                            ...
                            {availablePrivateFiles.map((f) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`flex w-full items-center justify-between rounded-lg px-3 py-1.5 text-left text-xs transition ${isSelected
                  ...
                  <ul className="max-h-52 space-y-2 overflow-y-auto">
                    {collaborators.map((c) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={`rounded-full px-2 py-0.5 text-[10px] font-semibold uppercase ${c.role === "editor"
